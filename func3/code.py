# Код, который суммирует длину имен из заданного списка после удаления тех, которые
# начинаются со строчной буквы. Используйте функцию lambda и функцию filter.
